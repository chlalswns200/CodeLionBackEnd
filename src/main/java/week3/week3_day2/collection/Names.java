...
public class Names {
    ...
    public List<Student> studentObj() {
        this.studentList.add(new Student("강동연", 1, "https://github.com/dongyeon-0822/java-project-exercise"));
        this.studentList.add(new Student("강수연", 1, "https://github.com/kang-subin/Java"));
        this.studentList.add(new Student("고관운", 3, "https://github.com/KoKwanwun/LikeLion.git"));
        this.studentList.add(new Student("고현석", 1, "https://github.com/lcomment/Algorithm_Solution--Java/tree/main/LikeLion"));
        this.studentList.add(new Student("최민준", 1, "https://github.com/chlalswns200/java_push"));
